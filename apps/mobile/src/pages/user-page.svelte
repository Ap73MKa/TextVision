...
{#if $user}
    <div class="min-h-full flex flex-col">
        <div class="w-full flex flex-col gap-4 justify-center items-center py-8">
            <h2 class="font-medium text-xl">My account</h2>
        ...
        <div class="w-full bg-background rounded-t-3xl border-t overflow-hidden grow p-4">
            <div class="text-center pt-2 pb-4">Personal info</div>
            <ul class="w-full flex flex-col gap-8 pb-8 border-b">
                <li class="w-ful flex gap-4 px-2 items-center">
                    ...
                    <div class="w-full flex flex-col">
                        <h3 class="text-muted-foreground">Username</h3>
                ...
                <li class="w-ful flex gap-4 px-2 items-center">
                    ...
                    <div class="w-full flex flex-col">
                        <h3 class="text-muted-foreground">Full name</h3>
                ...
                <li class="w-ful flex gap-4 px-2 items-center">
                    ...
                    <div class="w-full flex flex-col">
                        <h3 class="text-muted-foreground">Email</h3>
                        <span class="leading-5 text-lg">{$user.email}</span>
                    </div>
                </li>
            </ul>
            <button type="button" on:click={signOut} class="w-full flex text-left text-destructive gap-4 px-2 py-8 items-center">
                <div class="size-10 p-0.5">
                    <LogOutIcon class="size-full stroke-[1.3]" />
                </div>
                <div class="w-full flex flex-col">
                    <h3 class="leading-5 text-lg">Log out</h3>
                    <span class="text-destructive">Leave to change user</span>
                </div>
            </button>
        </div>
    </div>
